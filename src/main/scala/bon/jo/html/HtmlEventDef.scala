...
import org.scalajs.dom.raw.{CSSStyleDeclaration, DragEvent, Element, Event, FocusEvent, HTMLDocument, HTMLElement, KeyboardEvent, MouseEvent, PointerEvent, UIEvent, WheelEvent}
...
object Ex{
  ...
  case object onblur extends CaseEvent[FocusEvent]
}
trait HtmlEventDef {
  def html : HTMLElement

  def onblur = Ex.onblur(html,_)
  ...
  var onclick: js.Function1[MouseEvent, _] = _
